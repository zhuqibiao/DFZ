...
一把一把的吞服，难道你的身体真的“百毒不侵”？？
            ...
            <div class="dg_main">
                ...
                <div class="tel">
                    <div class="clear"></div>
                    <p>
                        免费咨询电话：<a class="tel_a" href="tel:4006996535" target="_blank">400-699-6535<span
  ...
  <br />
                        ...
                        <div class="bdbox">
                            <ul>
                                ...
                                <li class="product"><span class="bdl"><em>*</em>产品选择</span><br />
                                    ...
                                    <br>
                                    <input name="chanpin" type="radio" class="dxk" id="productc" value="2盒完美遮白斑装 550元" checked="checked">
                                    <label for="productb">2盒完美遮白斑装 550元<!--<IMG src="images/hot.gif">--></label>
                                    <br>
                                    <input name="chanpin" type="radio" class="dxk" id="producte" value="3盒遮白养白装 798元">
                                    <label for="productc">3盒遮白养白装 798元</label>
                                    <br>
        ...
        <div class="fixednav">
            <table border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
                <tbody>
                    <tr>
                        <td><a id="fixbtn2" class="fixbtn" href="tel:4006996535"><span>电话咨询</span></a></td>
        ...
        <script>
            ...
            (function () {
                ...
                hm.src = "//hm.baidu.com/hm.js?ec5ae6fd0fe2bcab6dc2460b12546b0d";
